            ...
            <Stack direction={"column"} justifyContent={"center"} rowGap={{xs: 3, md: 5}} sx={{
                ...
                <Stack justifyContent={"center"} alignItems={"center"} direction={"column"} sx={{
                    ...
                    <Stack direction={"row"} alignItems={"center"} justifyContent={"center"} gap={.5}>
                        ...
                        <IconButton href={"https://twitter.com/Nnaji_Christal?t=O_wFPasZiqBt7oco6Z6PHA&s=08"}><Twitter/></IconButton>
                        <IconButton href={"https://www.linkedin.com/in/nnaji-christabel-271b63255"}><LinkedIn/></IconButton>
                        <IconButton href={"https://instagram.com/nnaji_christy?igshid=ZDc4ODBmNjlmNQ=="}><Instagram/></IconButton>
                    </Stack>
